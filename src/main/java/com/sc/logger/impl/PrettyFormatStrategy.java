...
public class PrettyFormatStrategy implements FormatStrategy {
  ...
  @Override public void log(int priority, String message) {
  ...
  private void logHeaderContent(int logType, int methodCount) {
    ...
    if (showThreadInfo) {
      logChunk(logType, HORIZONTAL_LINE + " Thread: " + Thread.currentThread().getName());
      logDivider(logType);
    }
    String level = "";
  ...
  private void logChunk(int priority, String chunk) {
    logStrategy.log(priority, chunk);
  }
